...
const SIGNATURES = {
    ...
    dwForceAttack2: 0x31EDB2C,
    dwForceBackward: 0x31EDB74,
    dwForceForward: 0x31EDB50,
    dwForceJump: 0x52673DC,
    dwForceLeft: 0x31EDB68,
    dwForceRight: 0x31EDAF0,
    dwGameDir: 0x627700,
    dwGameRulesProxy: 0x52DA6BC,
    dwGetAllClasses: 0xDCBA7C,
    dwGlobalVars: 0x588CF0,
    dwGlowObjectManager: 0x5305AE0,
    dwInput: 0x520EB90,
    dwInterfaceLinkList: 0x954344,
    dwLocalPlayer: 0xDA344C,
    dwMouseEnable: 0xDA8F98,
    dwMouseEnablePtr: 0xDA8F68,
    dwPlayerResource: 0x31EBE70,
    dwRadarBase: 0x51F2344,
    dwSensitivity: 0xDA8E34,
    dwSensitivityPtr: 0xDA8E08,
    dwSetClanTag: 0x8A130,
    dwViewMatrix: 0x4DAEEE4,
    dwWeaponTable: 0x520F654,
    dwWeaponTableIndex: 0x326C,
    dwYawPtr: 0xDA8BF8,
    dwZoomSensitivityRatioPtr: 0xDADE98,
    dwbSendPackets: 0xD7BD2,
    dwppDirect3DDevice9: 0xA7050,
    find_hud_element: 0x360028C0,
    force_update_spectator_glow: 0x3B399A,
    interface_engine_cvar: 0x3E9EC,
    is_c4_owner: 0x3C08F0,
    m_bDormant: 0xED,
    m_flSpawnTime: 0x103C0,
    m_pStudioHdr: 0x2950,
    m_pitchClassPtr: 0x51F25E0,
