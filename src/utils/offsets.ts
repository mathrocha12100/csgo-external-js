...
const SIGNATURES = {
    ...
    dwForceAttack2: 0x31ECB40,
    dwForceBackward: 0x31ECAEC,
    dwForceForward: 0x31ECAF8,
    dwForceJump: 0x52663C4,
    dwForceLeft: 0x31ECB10,
    dwForceRight: 0x31ECB04,
    dwGameDir: 0x627700,
    dwGameRulesProxy: 0x52D96AC,
    dwGetAllClasses: 0xDCAA5C,
    dwGlobalVars: 0x588CF0,
    dwGlowObjectManager: 0x5304AC0,
    dwInput: 0x520DB78,
    dwInterfaceLinkList: 0x9538B4,
    dwLocalPlayer: 0xDA244C,
    dwMouseEnable: 0xDA7F98,
    dwMouseEnablePtr: 0xDA7F68,
    dwPlayerResource: 0x31EAE60,
    dwRadarBase: 0x51F132C,
    dwSensitivity: 0xDA7E34,
    dwSensitivityPtr: 0xDA7E08,
    dwSetClanTag: 0x8A130,
    dwViewMatrix: 0x4DADEB4,
    dwWeaponTable: 0x520E63C,
    dwWeaponTableIndex: 0x326C,
    dwYawPtr: 0xDA7BF8,
    dwZoomSensitivityRatioPtr: 0xDACE98,
    dwbSendPackets: 0xD7A62,
    dwppDirect3DDevice9: 0xA7050,
    find_hud_element: 0x331927A0,
    force_update_spectator_glow: 0x3B38CA,
    interface_engine_cvar: 0x3E9EC,
    is_c4_owner: 0x3C0820,
    m_bDormant: 0xED,
    m_flSpawnTime: 0x103C0,
    m_pStudioHdr: 0x2950,
    m_pitchClassPtr: 0x51F15C8,
    m_yawClassPtr: 0xDA7BF8,
    model_ambient_min: 0x58C00C,
    set_abs_angles: 0x1E37C0,
    set_abs_origin: 0x1E3600,
};

export { SIGNATURES, NETVARS, MODULES };